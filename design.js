...
function removeHearths() {
    const existingHearths = document.querySelectorAll('.heart');
    existingHearths.forEach(function(heart) {
        heart.remove();
    });
}
...
document.getElementById('lightTheme').addEventListener('click', function() {
    ...
    document.body.id = 'lightThemeBody';
...
document.getElementById('darkTheme').addEventListener('click', function() {
    ...
    document.body.id = 'darkThemeBody';
...
document.getElementById('valentinesTheme').addEventListener('click', function() {
    ...
    document.body.id = 'valentinesThemeBody';


    const hearths = 30; // Number of hearts

    for (let i = 0; i < hearths; i++) {
        const heart = document.createElement('div');
        heart.classList.add('heart');
        heart.innerHTML = '❤'; 
        heart.style.left = `${getRandomNumber(0, window.innerWidth)}px`;
        heart.style.animationDuration = `${getRandomNumber(5, 15)}s`;
        heart.style.animationDelay = `${getRandomNumber(0, 10)}s`;
...
document.getElementById('christmasTheme').addEventListener('click', function() {
    ...
    document.body.id = 'christmasThemeBody';
